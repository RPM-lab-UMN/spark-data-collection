...
## Data Pipeline
The new dataset collection and conversion work lives in [data_pipeline](./data_pipeline/). Start with the [data pipeline README](./data_pipeline/README.md) for the operator runbook and curated setup guides.
